...
public enum FontFamily {
  public enum SourceSansPro {
    ...
    public static let italic = FontConvertible(name: "SourceSansPro-It", family: "Source Sans Pro", path: "SourceSansPro-Italic.ttf")
    ...
    public static let all: [FontConvertible] = [bold, italic, regular, semiBold]
  }
  public static let allCustomFonts: [FontConvertible] = [SourceSansPro.all].flatMap { $0 }
